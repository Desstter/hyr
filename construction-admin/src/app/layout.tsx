...
export const metadata: Metadata = {
  ...
  description:
    "Sistema de administración para empresa de construcción y soldadura",
};
      ...
      <body className={inter.className} suppressHydrationWarning={true}>
        <div className="min-h-screen bg-background" suppressHydrationWarning>
          ...
          <div className="lg:pl-64" suppressHydrationWarning>
            ...
            <div
              className="hidden lg:block xl:hidden fixed top-20 right-6 z-40"
              suppressHydrationWarning
            >
              <QuickActions />
            </div>
          ...
          <div
            className="lg:hidden h-20 ios-safe-area-bottom"
            suppressHydrationWarning
          />
        </div>
