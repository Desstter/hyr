...
export default function ContractorsPage() {
  ...
  const loadContractors = async () => {
    try {
      ...
      if (filterObligated !== 'all') params.append('obligated_to_invoice', filterObligated);
      ...
      toast({
        ...
        description: "No se pudo conectar con el servidor. Verifique que el backend esté funcionando.",
        variant: "destructive",
      });
  ...
  const handleCreateDocumentSupport = async () => {
    if (!selectedContractor || !supportForm.concept || !supportForm.base_amount) {
      toast({
        title: "Error",
    ...
    if (selectedContractor.obligated_to_invoice) {
      toast({
        title: "Error",
        description: "Este contratista está obligado a facturar. No puede generar documento soporte.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const response = await fetch('http://localhost:3001/api/contractors/document-support', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex space-x-4">
            ...
            <div className="w-48">
              <Select value={filterObligated} onValueChange={setFilterObligated}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => setContractorForm(prev => ({ ...prev, document_type: value }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="col-span-2 space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setContractorForm(prev => ({ ...prev, document_number: e.target.value }))}
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setContractorForm(prev => ({ ...prev, obligated_to_invoice: e.target.checked }))}
              />
              <Label htmlFor="obligated">¿Obligado a facturar electrónicamente?</Label>
            </div>
          ...
          {selectedContractor && (
            <div className="space-y-4">
              <div className="p-3 bg-blue-50 rounded-lg">
                <h4 className="font-medium text-blue-900">{selectedContractor.name}</h4>
                <p className="text-sm text-blue-800">
                  {selectedContractor.document_type} {selectedContractor.document_number}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setSupportForm(prev => ({ ...prev, concept: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setSupportForm(prev => ({ ...prev, base_amount: e.target.value }))}
                  placeholder="0.00"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => setSupportForm(prev => ({ ...prev, service_type: value }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => setSupportForm(prev => ({ ...prev, apply_withholding: e.target.checked }))}
                />
                <Label htmlFor="withholding">Aplicar retención en la fuente</Label>
              </div>
              ...
              <div className="flex justify-end space-x-2 pt-4">
                ...
                <Button onClick={handleCreateDocumentSupport} disabled={submitting}>
                  {submitting ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> : null}
                  Crear Documento
                </Button>
              </div>
      ...
      <Card className="border-yellow-200 bg-yellow-50">
        <CardContent className="p-4">
          <h4 className="font-medium text-yellow-800 mb-2">📋 Información sobre Contratistas</h4>
          <ul className="text-yellow-700 text-sm space-y-1">
            <li>• <strong>Obligados a facturar:</strong> Pueden emitir facturas electrónicas (no aplica doc. soporte)</li>
            <li>• <strong>No obligados:</strong> Se les debe generar documento soporte por compras</li>
            <li>• <strong>Documento soporte:</strong> Obligatorio para compras a no obligados a facturar</li>
            <li>• <strong>Retenciones:</strong> Se aplican automáticamente según tipo de servicio</li>
          </ul>
        </CardContent>
      </Card>
    </div>
