  ...
  const onSubmit = async (data: PaymentReminderFormData) => {
    ...
    try {
      const eventData = {
        ...
        project_id:
          data.project_id === "no-project" ? undefined : data.project_id,
      };
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="Ej: Pago de seguro vehicular"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="tax">
                        {getCategoryLabel("tax")}
                      </SelectItem>
                      <SelectItem value="insurance">
                        {getCategoryLabel("insurance")}
                      </SelectItem>
                      <SelectItem value="permit">
                        {getCategoryLabel("permit")}
                      </SelectItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="none">
                        {getRecurringLabel("none")}
                      </SelectItem>
                      <SelectItem value="monthly">
                        {getRecurringLabel("monthly")}
                      </SelectItem>
                      <SelectItem value="quarterly">
                        {getRecurringLabel("quarterly")}
                      </SelectItem>
                      <SelectItem value="yearly">
                        {getRecurringLabel("yearly")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
