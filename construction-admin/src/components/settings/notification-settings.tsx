  ...
  useEffect(() => {
    const loadSettings = async () => {
      try {
        ...
        toast.error(
          "Error al cargar configuraciones de notificaciones: " + errorMessage
        );
      } finally {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Badge variant="secondary">{notificationCount} activas</Badge>
        </div>
          ...
          <div className="grid gap-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleChange("payrollReminders", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleChange("projectDeadlines", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Notificaciones sobre gastos elevados y aprobaciones
                    pendientes
                  </p>
                </div>
              </div>
              <Switch
                ...
                onCheckedChange={checked =>
                  handleChange("expenseAlerts", checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  handleChange("budgetWarnings", checked)
                }
              />
            </div>
          </div>
        ...
        <div className="pt-4 border-t">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.pushEnabled ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Notificaciones Push:{" "}
                {settings.pushEnabled ? "Activas" : "Inactivas"}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.emailEnabled ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Email: {settings.emailEnabled ? "Activo" : "Inactivo"}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.payrollReminders ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Nómina: {settings.payrollReminders ? "Activa" : "Inactiva"}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.projectDeadlines ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Proyectos: {settings.projectDeadlines ? "Activas" : "Inactivas"}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.expenseAlerts ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Gastos: {settings.expenseAlerts ? "Activas" : "Inactivas"}
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${settings.budgetWarnings ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              <span>
                Presupuesto: {settings.budgetWarnings ? "Activas" : "Inactivas"}
              </span>
            </div>
          </div>
        </div>
