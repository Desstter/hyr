...
const navigation = [
  ...
  { name: 'payroll_electronic', href: '/payroll/generate', icon: FileSpreadsheet },
...
export function Sidebar() {
  ...
  return (
    <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0" suppressHydrationWarning>
      <div className="flex-1 flex flex-col min-h-0 bg-card border-r border-border shadow-sm" suppressHydrationWarning>
        ...
        {/* Footer */}
        <div className="flex-shrink-0 border-t border-border p-4" suppressHydrationWarning>
          <div className="hyr-card p-4 bg-gradient-to-r from-primary/5 to-secondary/5" suppressHydrationWarning>
