      ...
      <div className="flex items-center space-x-1" suppressHydrationWarning>
          <Tooltip content={t.quickActions.newProject}>
            ...
            >
              ...
              <span className="hidden 2xl:inline">{t.quickActions.newProject}</span>
            </Button>
          </Tooltip>
          <Tooltip content={t.quickActions.addEmployee}>
            ...
            >
              ...
              <span className="hidden 2xl:inline">{t.quickActions.addEmployee}</span>
            </Button>
          </Tooltip>
          <Tooltip content={t.quickActions.logExpense}>
            ...
            >
              ...
              <span className="hidden 2xl:inline">{t.quickActions.logExpense}</span>
            </Button>
          </Tooltip>
          ...
          <Tooltip content={t.quickActions.createEstimate}>
            ...
            >
              ...
              <span className="hidden 2xl:inline">{t.quickActions.createEstimate}</span>
            </Button>
          </Tooltip>
      </div>

      {/* Mobile Quick Actions - Floating Bottom Bar */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 px-4 py-3" suppressHydrationWarning>
        <div className="flex items-center justify-around space-x-2" suppressHydrationWarning>
          <Button 
            size="sm" 
            onClick={handleNewProject}
