...
export default function ContractorDetailPage() {
  ...
  const [contractorData, setContractorData] = useState<ContractorDetail | null>(
    null
  );
            ...
            {!contractor.obligated_to_invoice ? (
              ...
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  Este contratista está obligado a facturar electrónicamente. No
                  requiere documentos soporte.
                </p>
              </div>
            )}
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="p-4">
          <h4 className="font-medium text-blue-800 mb-2">
            ℹ️ Información sobre Documentos Soporte
          </h4>
          <ul className="text-blue-700 text-sm space-y-1">
            <li>
              • Los documentos soporte son obligatorios para compras a no
              obligados a facturar
            </li>
            <li>
              • Se aplican automáticamente las retenciones según el tipo de
              servicio
            </li>
            <li>
              • Para construcción se aplica seguridad social sobre el 40% si
              supera 4 UVT
            </li>
            <li>
              • Los documentos se envían automáticamente a la DIAN para
              validación
            </li>
          </ul>
        </CardContent>
